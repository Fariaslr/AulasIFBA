...
rename column dia to descricaoDia;  

describe diasemana;

select * from localdaaula;
...
SELECT * FROM materia 
JOIN localdaaula ON materia.codigoLocalDaAula = localdaaula.codigoLocalDaAula;

INSERT into materia
VALUE(default,"Informática na educação","1",null,"1");
